...
export const PACKS = [
  ...
  { id: 'personagens', emoji: '🦸', name: 'Personagens', free: true,
    words: ['Mickey Mouse','Pato Donald','Pernalonga','Bob Esponja','Homer Simpson','Pikachu','Super Mario','Sonic',
      'Woody','Buzz Lightyear','Simba','Elsa','Olaf','Nemo','Dory','Ariel','Aladdin','Gênio','Mogli','Peter Pan',
      'Pinóquio','Branca de Neve','Rapunzel','Moana','Minions','Po','Scooby-Doo','Popeye','Tom e Jerry','Pica-Pau',
      'Mônica','Cebolinha','Cascão','Magali','Zé Colmeia','Fred Flintstone','Garfield','Snoopy','Hulk','Yoda',
      'Darth Vader','Gandalf','Wall-E','Shrek','Homem-Aranha'] },
